    ...
    <div v-else-if="activeTab === 'users'" class="tab-content">
      ...
      <div v-else class="users-table">
        <div class="table-header">
          ...
          <div class="col-stats">Статистика</div>
          <div class="col-actions">Действия</div>
        </div>
        ...
        <div v-for="user in users" :key="user.id" class="table-row">
          ...
          <div class="col-stats">
            <button @click="loadUserStats(user.id)" class="stats-btn">Показать</button>
          </div>
          <div class="col-actions">
...
.users-table .table-header {
  grid-template-columns: 60px 1fr 1.5fr 200px 100px 120px;
}
